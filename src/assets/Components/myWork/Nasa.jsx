...
import unoNasa from "../../img/nasa/Captura.jpg"
import dosNasa from "../../img/nasa/Captura2.jpg"
import tresNasa from "../../img/nasa/Captura3.jpg"
import cuatroNasa from "../../img/nasa/Captura4.jpg"
...
export default function Nasa(){
    ...
    const handleNextImage = () => {
      setCurrentImageIndex((prevIndex) => (prevIndex + 1) % imagesNasa.length);
    console.log('hola desde nex');
    };
  
    const handlePrevImage = () => {
      setCurrentImageIndex((prevIndex) =>
        prevIndex === 0 ? imagesNasa.length - 1 : prevIndex - 1
      );
    ...
    return (
        ...
        <section className="carousel-section">
            <div className="carousel">
              {imagesNasa.map((image, index) => (
                <a href="https://github.com/aguirres-L/nasa">
                <img
                  key={image.id}
                  src={image.src}
                  alt={`Image ${index + 1}`}
